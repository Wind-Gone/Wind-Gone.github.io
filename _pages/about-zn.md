...
📝 论文
======
- 王清帅, 李好, **胡梓锐**, 张蓉, 杨程程, 蔡鹏, 周烜, 周傲英. Mirage: Generating Enormous Databases for Complex Workloads. IEEE International Conference on Data Engineering (``ICDE``) (计算机科学, **CCF-A 国际**), 2024, [PDF](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10597682). [![](https://img.shields.io/github/stars/DBHammer/Mirage?style=social&label=Code+Stars)](https://github.com/DBHammer/Mirage)
- 李好, 王清帅, **胡梓锐**, 黄煦华, 倪葎, 张蓉, 周烜. Touchstone+ : Query Aware Database Generation for Match Operators. Database Systems for Advanced Applications (``DASFAA``) (计算机科学, **CCF-B 国际**), 2024. [PDF](https://www.dasfaa2024.org/research-papers/).

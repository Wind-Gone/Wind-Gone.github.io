...
His research focuses on database kernel technology, especially for HTAP databases optimization, benchmark design, query optimization and ai4db.
...
- Qingshuai Wang, Hao Li, **Zirui Hu**, Rong Zhang, Chengcheng Yang, Dian Qiao, Xuan Zhou, and Aoying Zhou. Mirage: Generating Enormous Databases for Complex Workloads. VLDB (CCF-A). 2023. [PDF](), [Code]().

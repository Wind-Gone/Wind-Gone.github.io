...
<!-- : Retrieval-Augmented Generation Enables Better Automatic Database Knob Tuning. -->
...
- <span style="color: #FF4500; font-weight: bold;">[ICDE'25]</span> Rabbit: Retrieval-Augmented Generation Enables Better Automatic Database Knob Tuning. (Computer Science, **CCF-A Conference**), [PDF]().
